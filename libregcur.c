...
inline void update(scicos_block *blk, struct pi_reg_state *s, int32_t e, int32_t fs)
{
	int32_t a = s->a;
	int32_t d = s->ki*e;
...
inline int32_t svpwm(int32_t *abc, int32_t *dq, int32_t phase)
{
	int32_t fs = 0;
	int32_t mag;
	int32_t ang;
...
void pi_reg_cur(scicos_block *blk, int flag)
{
	...
	case 2:		
		...
		dreg.ki = (int32_t)(r_IN(2, 0)*1024);
		dreg.kp = (int32_t)(r_IN(3, 0)*1024);
		
		qreg.ki = (int32_t)(r_IN(2, 0)*1024);
		qreg.kp = (int32_t)(r_IN(3, 0)*1024);
